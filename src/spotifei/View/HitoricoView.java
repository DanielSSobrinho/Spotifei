 ...
 */
public class HitoricoView extends javax.swing.JFrame {

    /**
     * Creates new form HitoricoView
     */
    public HitoricoView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HitoricoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HitoricoView().setVisible(true);
            }
        });
    }
    ...
    List<Musica> lista = dao.buscarHistorico(idUsuario);
